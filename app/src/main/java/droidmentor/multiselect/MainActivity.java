...
public class MainActivity extends AppCompatActivity implements AlertDialogHelper.AlertDialogListener{
    ...
    public void data_load() {
        String name[] = {"Gokul", "Rajesh", "Ranjith", "Madhu", "Ameer", "Sonaal", "Rajesh", "Ranjith", "Madhu", "Ameer", "Sonaal", "Rajesh", "Ranjith", "Madhu", "Ameer", "Sonaal"};
        String posting[] = {"Manager", "HR", "Android Developer", "iOS Developer", "Team Leader", "Designer", "HR", "Android Developer", "iOS Developer", "Team Leader", "Designer", "HR", "Android Developer", "iOS Developer", "Team Leader", "Designer"};
